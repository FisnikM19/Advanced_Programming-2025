...
class Queue<T>{
    ...
    private Node<T> front; // Points to the first element (for dequeue/peek)
    private Node<T> rear; // Points to the last element (for enqueue/inspect)
    private int size;
    ...
    public void enqueue(T element) {
        Node<T> node = new Node<>(element, null); // New node points to null (it's the last)
