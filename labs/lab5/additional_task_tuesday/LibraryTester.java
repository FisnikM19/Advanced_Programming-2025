package labs.lab5.additional_task_tuesday;
...
class LibrarySystem {
    ...
    public Map<Book, Integer> getBooksAndNumberOfBorrowings() {
        ...
        for (Book book: books.values()) {
            result.put(book, book.getTotalBorrows());
        }
...
//                        book -> book,                    // key: the Book object
//                        Book::getTotalBorrows,           // value: total borrows
//                        (v1, v2) -> v1,                  // merge function (not needed here but required)
//                        () -> new TreeMap<>(Comparator.comparing(Book::getTitle))  // map supplier
//                ));
//    }
            ...
            while ((line = br.readLine()) != null) {
                ...
                switch (parts[0]) {
                    ...
                    case "printBookCurrentBorrowers": {
                        ...
                        System.out.println("Total borrowers: (additional method 1) -> " + lib.getBooksAndNumberOfBorrowings()); //TODO:Method 1
                        break;
                    }

                    case "printTopAuthors": {
                        lib.printTopAuthors();
                        System.out.println("Authors and isbn numbers: (additional method 2) -> " + lib.getAuthorsWithBooks());
                        break;
                    }
