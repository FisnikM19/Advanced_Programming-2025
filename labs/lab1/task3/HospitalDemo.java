...
public class HospitalDemo {
    public static void main(String[] args) {
        ...
        Predicate<Doctor> highPatients = d -> d.getPatients() > 20;
        System.out.println("\n=== Doctors with higher number of patients and a higher level of expertise ===");
        HighExpertiseEvaluator highExpertise = new HighExpertiseEvaluator();
        Doctor[] passing = er.evaluate(highExpertise);;
        for (Doctor d : passing) {
            if (highPatients.test(d)) {
