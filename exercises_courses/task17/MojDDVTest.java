package exercises_courses.task17;
...
class Receipts {
    ...
    public String toString() {
        return String.format("%10s\t%10.0f\t%10.5f", id, getTotalAmount(), getTaxReturn());
    }
}
...
class MojDDV {
    ...
    double min() {
        return receipts.stream()
                .mapToDouble(Receipts::getTaxReturn)
                .min()
                .orElse(0.0);
    }
    ...
    public void printStatistics (OutputStream outputStream) {
        ...
        writer.println(String.format("min:\t%.3f", min()));
        writer.println(String.format("max:\t%.3f", max()));
        writer.println(String.format("sum:\t%.3f", sum()));
        writer.println(String.format("count:\t%-5d", receipts.size()));
        writer.println(String.format("avg:\t%.3f", average()));
